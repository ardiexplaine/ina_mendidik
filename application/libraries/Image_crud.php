...
class Image_crud {
    ...
    protected function _get_delete_url($value)
    {
    	...
    	return site_url($this->modules.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/delete_file/'.$value);
    }
	...
	protected function getState()
	{
		...
		{
			$upload_url = site_url($this->modules.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/upload_file/'.$rsegments_array[3]);
			$ajax_list_url  = site_url($this->modules.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/'.$rsegments_array[3].'/ajax_list');
			$ordering_url  = site_url($this->modules.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/ordering');
			$insert_title_url  = site_url($this->modules.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/insert_title');
		...
		{
			$upload_url = site_url($this->modules.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/upload_file');
			$ajax_list_url  = site_url($this->modules.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/ajax_list');
			$ordering_url  = site_url($this->modules.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/ordering');
			$insert_title_url  = site_url($this->modules.'/'.$rsegments_array[1].'/'.$rsegments_array[2].'/insert_title');
